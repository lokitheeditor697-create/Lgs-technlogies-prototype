      ...
      <div className="pt-24 pb-8 max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1">
            ...
            {activeSidebar !== 'Enrolled Courses' && activeSidebar !== 'Settings' && (
              <div className="bg-gray-50 border border-gray-200 border-dashed rounded-2xl p-12 text-center">
                <div className="w-16 h-16 bg-white shadow-sm text-gray-400 rounded-full flex items-center justify-center mx-auto mb-4">
                  <FiClock className="w-8 h-8" />
                </div>
                <h2 className="text-2xl font-bold text-gray-900 mb-2">{activeSidebar}</h2>
                <p className="text-gray-500">This feature is currently under development. Check back soon!</p>
              </div>
            )}
