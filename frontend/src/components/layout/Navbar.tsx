            ...
            {user ? (
              <>
                <div className="relative group">
                  ...
                  <div className={`absolute right-0 top-full w-56 bg-white rounded-xl shadow-lg border border-gray-100 transition-all duration-200 transform origin-top-right pt-2 ${dropdownOpen ? 'opacity-100 visible scale-100' : 'opacity-0 invisible scale-95 group-hover:opacity-100 group-hover:visible group-hover:scale-100'}`}>
